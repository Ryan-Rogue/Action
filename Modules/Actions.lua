...
local _G, type, pairs, select, unpack, table, setmetatable, math 	= 	
	  _G, type, pairs, select, unpack, table, setmetatable, math
...
function A.GetSpellDescription(self)
    ...
    if text then 
		...
		-- [1] %f[%d]%d[.%d]*
		-- [2] %f[%d]%d[.%d]*%f[%D] -- full
		for value in descriptioncache[text]:gmatch("[%f%d][.%d]*") do 

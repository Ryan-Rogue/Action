...
* [7] is Passive rotation (limited actions, usually @raid2, @party2, @arena2) / AntiFake CC Focus rotation
* [8] is Passive rotation (limited actions, usually @raid3, @party3, @arena3) / AntiFake Interrupt Focus rotation
* [9] is AntiFake CC2 rotation (extra, not available in most profiles!)
* [10] is AntiFake CC2 Focus rotation (extra, not available in most profiles!)
Passive rotation doesn't require START button use like it does [1] -> [5], [7] -> [10] (AntiFake) rotations 

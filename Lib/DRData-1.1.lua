-- Original DRData-1.0 which uses in TMW is out dated a lot and many spells was removed or changed 
-- I decided to update it without cause issues for default TMW with additional changes for my needs 
...
local spellsAndProvidersByCategory = {
	...
	disorient = {
		-- Death Knight
		[207167] = true, -- Blinding Sleet (talent) 
		-- Demon Hunter
	...
	stun = {
		...
		[ 47481] = true, -- Gnaw (pet)
		-- [ 91800] = true, -- Gnaw (Ghoul) -- old
		-- [ 91797] = true, -- Monstrous Blow (Dark Transformation Ghoul) -- old 
		[212332] = true, -- Smash (transformation pet)
		...
		--[236026] = true, -- Maim (Honor talent) -- old 
		--[22570] = true, -- Maim (Honor talent) -- old 
		[  5211] = true, -- Mighty Bash
		[163505] = 1822, -- Rake (Stun from stealth)
		[  2637] = true, -- Hibernate
		-- Hunter
		...
		-- Mage
		-- Monk
		--[120086] =   true, -- Fists of Fury (with Heavy-Handed Strikes, pvp talent) -- old 
		--[232055] =   true, -- Fists of Fury (new ID in 7.1) -- old 
...
local function CheckDeprecatedCategory(cat)
	if cat and deprecatedCategories[cat] then
		geterrorhandler()(format("Diminishing return category '%s' does not exist anymore. The addon using DRData-1.1 may be outdated. Please consider upgrading it.", cat))
